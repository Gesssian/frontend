...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  climbers = {
     ...
     * @secure
     */
    climbersUpdateUpdate: (climberId: string, data: Climber, params: RequestParams = {}) =>
      this.request<Climber, any>({
